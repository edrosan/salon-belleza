...
function addServicios($result)
{
  foreach ($result as $value) {
    ...
    <a href="#" class="flex w-[15px] flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 ">
    <img class="object-cover w-fullrounded-t-lg h-0 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="'.$value['imagen'].'" alt="">
    <div class="flex flex-col justify-between p-4 leading-normal">
      <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">'.($value['servicio']).'</h5>
      <p class="mb-3  text-gray-700 ">' . $value['duracion'] . ' min</p>
      <p class="mb-3 font-normal text-gray-700 ">$' . $value['precio'] . '</p>
    </div>
  </a>

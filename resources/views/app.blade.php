...
<body class=" bg-[#fffbff] min-h-screen" >
    ...
    <nav class="bg-[#fffbff]	" x-data="{ open: false}">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <!-- <a href="#" class="bg-[#4b57a9] text-[#ffffff] px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Inicio</a> -->
          ...
          @else
          <div>
            <a href="{{ route('registro') }}" class="bg-[#fffbff] text-[#1b1b1f] hover:bg-[#dfe0ff] hover:text-[#000d5f] px-3 py-2 rounded-md text-sm font-medium">Registro</a>
            <a href="#" class="bg-[#fffbff] text-[#1b1b1f] hover:bg-[#dfe0ff] hover:text-[#000d5f] px-3 py-2 rounded-md text-sm font-medium">Login</a>
          </div>
          @endauth
      ...
      <div x-show="open" x-on:click.away="open = false" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
          <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
          <!-- <a href="#" class="bg-gray-900 on-menu-color block px-3 py-2 rounded-md text-base font-medium" aria-current="page">Inicio</a> -->
